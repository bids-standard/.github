...
2. Responsibility. Each contribution built with AI must be carefully proofread by the BIDS community member. Ultimately, the BIDS community member who post a contribution is taking responsibility for its content and must be able to explain their contribution in more details upon request.
